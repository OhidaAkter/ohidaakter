...
|---|---|---|
| [YouTube Summarizer Agent](https://github.com/OhidaAkter/youtube-summarizer-agent) | AI agent that summarizes YouTube videos in any language | Python, LangChain, Groq, Streamlit |
| [Spam Email Detector](https://github.com/OhidaAkter/Spam-Email-Detection) | ML web app to detect spam & phishing emails | Python, Scikit-learn, Streamlit |
| [My Portfolio](https://github.com/OhidaAkter/MyPortfolio) | Personal academic portfolio website | HTML, CSS |
